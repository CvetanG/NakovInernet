...
/**
 * NakovChatServer class is the entry point for the server. It opens a server
 ...
 * ServerDispatcher.
 */
// ima go v class v sushtiq package
class ClientListener extends Thread {
	...
	public ClientListener(Client aClient, ServerDispatcher aSrvDispatcher) throws IOException {
		...
		Socket socket = aClient.mSocket;
		socket.setSoTimeout(NakovChatServer.CLIENT_READ_TIMEOUT);
